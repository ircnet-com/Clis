...
@Component
@Slf4j
public class YouAreServiceEventListener extends AbstractEventListener<YouAreServiceEvent, SingletonIRCConnectionService> {
    private final SettingService settingService;

    public YouAreServiceEventListener(SingletonIRCConnectionService ircConnectionService,
    ...
    protected void onEvent(YouAreServiceEvent event) {
        log.info("Service connected as {}", event.getServiceName());
